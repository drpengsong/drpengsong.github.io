...
1. Wenjing Zhang#, <u>Peng Song*</u>, Dongliang Chen. Joint Local-Global Discriminative Subspace Transfer Learning for Facial Expression Recognition. ***IEEE Signal Processing Letters*** (Under Review)
2. Dongliang Chen#, <u>Peng Song*</u>, Wenming Zheng. Learning Transferable Sparse Representations for Cross-corpus Facial Expression Recognition. ***IEEE Transactions on Affective Computing*** (Minor revision)
3. Dongliang Chen#, <u>Peng Song*</u>, Wenjing Zhang, Wenming Zheng. Joint Transfer Sparse Coding and Subspace Learning for Cross-corpus Facial Expression Recognition. ***IEEE Transactions on Multimedia*** (Under Review)
...
2029. Tengfei Song, Wenming Zheng, <u>Peng Song</u>, Zhen Cui, EEG Emotion Recognition Using Dynamical Graph Convolutional Neural Networks, ***IEEE Transactions on Affective Computing***. 2020, 11(3): 532-541. （**ESI高被引**）
