...
* *09/08/2021* 祝贺论文“Emotion Recognition Using Dynamical Graph Convolutional Neural Networks”入选IEEE Transactions on Affective Computing最佳论文！
...
2019级
1. [张雯婧]()，研究方向：基于迁移学习的跨域人脸表情识别 (DSP论文刊出一篇、《数据采集与处理》刊出一篇、DSP刊出论文一篇、两篇论文在审)
2. [盛超]()， 研究方向：基于图正则的无监督特征选择 (DSP论文刊出一篇、《信号处理》录用一篇、DSP刊出论文一篇、一篇论文在审)
